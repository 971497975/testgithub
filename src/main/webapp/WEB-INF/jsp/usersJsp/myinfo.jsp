...
<%@ include file="/WEB-INF/jsp/head.jspf" %>
  ...
  <br><br>
    <table class="table table-hover table-bordered" style="margin:auto; width:40%;">
	  <thead>
	    <tr>
	      <th colspan="4"><center><font color='red' size='3'>我的信息</font></center></th>
	    </tr>
	    <tr>
	    ...
	    <tr>
	      <td width="40%"><center><b>籍贯</b></center></td>
	      <td><input type="text" class="input-text radius" value="${user.JG}" readonly="readonly"></td>
	    </tr>
	    <tr>
	      <td width="40%"><center><b>参加工作时间</b></center></td>
	      <td><b><fmt:formatDate value="${user.CJGZSJ}" pattern="yyyy-MM-dd"/></b></td>
	    </tr>
	    <tr>
